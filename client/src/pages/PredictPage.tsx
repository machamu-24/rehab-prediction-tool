...
const PATIENT_FIELDS: SectionDef[] = [
  ...
  { section: "神経学的評価", fields: [
    ...
    { key: "spatial_neglect",  label: "空間無視",     type: "boolean" },
  ]},
  { section: "運動機能評価", fields: [
    ...
    { key: "fugl_meyer_lower",       label: "Fugl-Meyer 下肢",              type: "number", unit: "点",  placeholder: "0〜34" },
  ...
  { section: "ADL評価（FIM）", fields: [
    { key: "fim_motor",        label: "FIM 運動項目",  type: "number", unit: "点",  placeholder: "13〜91" },
    { key: "fim_cognitive",    label: "FIM 認知項目",  type: "number", unit: "点",  placeholder: "5〜35" },
